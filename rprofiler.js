...
(function (CookieIdentifier) {
    ...
    CookieIdentifier["SessionReplayPostFlag"] = "sf";
...
var MainConfig = /** @class */ (function () {
    ...
    MainConfig.config = {
        ...
        sessionReplaySampleRate: -777, // range [0 - 100]
...
var VisitorStorage = /** @class */ (function () {
        ...
        for (var _i = 0, split_1 = split; _i < split_1.length; _i++) {
            ...
            switch (key) {
                ...
                case CookieIdentifier.PostFlag:
                    this.postFlag = num;
                    break;
                case CookieIdentifier.SessionReplayPostFlag:
                    this.sessionReplayPostFlag = num;
                    break;
            }
        }
        return true;
    ...
    VisitorStorage.prototype.getText = function () {
        ...
        text += CookieIdentifier.SessionReplayPostFlag + ':' + this.sessionReplayPostFlag;
        return text;
    };
...
var Visitor = /** @class */ (function () {
    ...
    Visitor.prototype.checkAndResetPostFlags = function () {
        ...
        this.store.sessionReplayPostFlag = 0;
        if (config.config.sampleRate < 0) {
            this.store.postFlag = -1;
            return;
        }
        if (config.config.sessionReplaySampleRate < 0) {
            this.store.sessionReplayPostFlag = -1;
            return;
        }
        // Set RUM post flag and waterfall flag
        ...
        // Set session replay post flag
        var srRate = this.getUserId(config.config.sessionReplaySampleRate / 100);
        if (this.store.userId <= srRate) {
            this.store.sessionReplayPostFlag = 1;
        }
    };
    ...
    Visitor.prototype.shouldPostSessionReplay = function () {
        return this.store.sessionReplayPostFlag == 1;
    };
    return Visitor;
}());
        ...
        switch (_a.label) {
            ...
            case 2:
                ...
                config.setAppConfig({
                    ...
                    sessionReplaySampleRate: appDetails.SessionReplaySampleRate
                });
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
...
var RProfiler = /** @class */ (function () {
    function RProfiler() {
        ...
        this.getSessionReplayFlag = function () {
            var _a;
            return (_a = config.config.sessionReplayEnabled) !== null && _a !== void 0 ? _a : false;
        };
        ...
        this.getVisitorInfo = function () {
            ...
            return {
                sessionId: _this.visitor.store.sessionId,
                userId: _this.visitor.store.userId,
                sessionReplayPostFlag: _this.visitor.store.sessionReplayPostFlag,
                shouldPostSessionReplay: _this.visitor.shouldPostSessionReplay.bind(_this.visitor)
            };
        };
